// Archivo: implementaciones/FacialTreatment.java
// Nota: Requiere ServiceElement, Billable, Schedulable, y Service (S04)
public class FacialTreatment extends ServiceElement implements Billable, Schedulable {
    ...
    public String getRoleDescription() {
        return "Tratamiento Facial - Duración: " + this.durationMinutes + " min";
    }
}